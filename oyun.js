...
// lerp kesme noktalarini hesaplar
...
var noise = (x) => {
  ...
  /*  //Math.floor bir onceki tam sayıyı döndürür
    return pts[Math.floor(x)]; */

  //Math.ceil bir sonraki tam sayıyı döndürür
  //return pts[Math.floor(x)]

  // floor ile ceil lerpten gecirebiliriz
  return lerp(pts[Math.floor(x)], pts[Math.ceil(x)], x - Math.floor(x));
};

// iki boyutlu cizimler kullanmak icin context kullanilir
...
var player = new (function () {
  ...
  this.truck.src = "monstertruck2.png";
  this.rot = 0;
  this.ySpeed = 0;
  this.rSpeed = 0;
  ...
  this.draw = function () {
    ...
    //n 5 pixel otesindeki noktaya gore aci hesapla egim icin
    var p2 = c.height * 0.9 - noise(this.x + t + 5) * yRatio;

    //gdn yerde mi havada mi oldugunu kontrol et
...
/*    ctx.drawImage(this.leftBtn, 20,c.height - 90 , 70, 70);
      ...
      /* Koordinatlar
        left  x 20 - 90, y c.height - 90, c.height - 20
        right x 110 - 180, y c.height - 90, c.height - 20
        fire x c.width - 90 - c.width - 20, y c.height - 90, c.height - 20
